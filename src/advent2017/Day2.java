...
public class Day2 implements IAdventSolution
{
	...
	{
		String input = "5048\t177\t5280\t5058\t4504\t3805\t5735\t220\t4362\t1809\t1521\t230\t772\t1088\t178\t1794\n" +
		...
		for (String row : rows)
		{
			...
			checkSum += Math.abs(nums[nums.length - 1] - nums[0]);
		}

		System.out.println(String.format("CheckSum is [%d]", checkSum));
	}
